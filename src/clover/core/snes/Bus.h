...
namespace clover::core
{
    ...
    public:
        ...
        // Large enough to retain several frames of a polling-heavy CPU/APU
        // transfer when diagnosing command/acknowledgement boundaries.
        static constexpr size_t k_apu_port_trace_capacity{ 16384 };
        ...
        struct apu_port_trace_t
        {
            ...
            timing_snapshot_t timing{};
            cpu_state_t cpu{};
            std::array<uint8_t, 7> apu_ram_probe{};
        };
        ...
        struct pending_cpu_write_t
        {
            ...
            [[nodiscard]] bool operator==(const pending_cpu_write_t&) const noexcept = default;
        };
        ...
        struct pending_ppu_write_t
        {
            ...
            [[nodiscard]] bool operator==(const pending_ppu_write_t&) const noexcept = default;
        };
        ...
        struct pending_apu_write_t
        {
            ...
            [[nodiscard]] bool operator==(const pending_apu_write_t&) const noexcept = default;
        };
        ...
        struct causal_state_t
        {
            ...
            std::array<uint8_t, k_wram_size> wram{};
            startup_entropy_mode_t entropy_mode{ startup_entropy_mode_t::none };
            bool entropy_seed_override_enabled{ false };
            uint32_t entropy_seed{ 0u };
            uint32_t entropy_sequence{ 0u };
            uint8_t open_bus{ 0 };
            std::array<pending_cpu_write_t, 16> pending_cpu_writes{};
            uint8_t pending_cpu_write_count{ 0 };
            std::array<pending_ppu_write_t, 16> pending_ppu_writes{};
            uint8_t pending_ppu_write_count{ 0 };
            std::array<pending_apu_write_t, 16> pending_apu_writes{};
            uint8_t pending_apu_write_count{ 0 };
            master_clock_delta_t apu_progressed_cpu_clocks{ 0 };
        ...
        [[nodiscard]] causal_state_t capture_causal_state() const noexcept;
    ...
    using bus_causal_state_t = bus_t::causal_state_t;
}
